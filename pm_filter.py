...
async def filter_languages_cb_handler(client: Client, query: CallbackQuery):
    ...
    # if ENABLE_SHORTLINK == True:
    btn.insert(0, [
        InlineKeyboardButton('❗❗  ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ  ❗❗', url="https://t.me/c/2026178604/11")
    ])
    # else:
    #     btn.insert(0, [
    #         InlineKeyboardButton("Sᴛᴀʀᴛ Bᴏᴛ", url=f"https://telegram.me/{temp.U_NAME}"),
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
                    InlineKeyboardButton('🔸 ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ 🔹', url=f'http://t.me/{temp.U_NAME}?startgroup=false')
                ],[
                    InlineKeyboardButton('ᴄʜᴀɴɴᴇʟ', url=CHNL_LNK),
                    InlineKeyboardButton('ɢʀᴏᴜᴘ', url=GRP_LNK)
                ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴏᴡɴᴇʀ', url="https://t.me/N33VARP=false"),
